...
public:
    ...
    void setupUi(QDialog *AdjustBMParam)
    {
        ...
        preFilterCap->setMinimum(1);
        preFilterCap->setMaximum(31);
        preFilterCap->setValue(1);
        ...
        QObject::connect(preFilterSz, SIGNAL(sliderReleased()), AdjustBMParam, SLOT(tryParam()));
        QObject::connect(preFilterCap, SIGNAL(sliderReleased()), AdjustBMParam, SLOT(tryParam()));
        QObject::connect(SADWndSz, SIGNAL(sliderReleased()), AdjustBMParam, SLOT(tryParam()));
        QObject::connect(textureth, SIGNAL(sliderReleased()), AdjustBMParam, SLOT(tryParam()));
        QObject::connect(minDisp, SIGNAL(sliderReleased()), AdjustBMParam, SLOT(tryParam()));
        QObject::connect(numDisp, SIGNAL(sliderReleased()), AdjustBMParam, SLOT(tryParam()));
        QObject::connect(uniq, SIGNAL(sliderReleased()), AdjustBMParam, SLOT(tryParam()));
        QObject::connect(speckleWndSz, SIGNAL(sliderReleased()), AdjustBMParam, SLOT(tryParam()));
        QObject::connect(specklerange, SIGNAL(sliderReleased()), AdjustBMParam, SLOT(tryParam()));
