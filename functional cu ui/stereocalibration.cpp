...
int StereoCalibration::rectifyImages(CvArr* leftImage, CvArr* rightImage, int rectify_mode){
    ...
    IplImage* leftImageGray = cvCreateImage(cvSize(mS_image_size.width, mS_image_size.height), 8,1);
    cvCvtColor(leftImage, leftImageGray, CV_BGR2GRAY);

    IplImage* rightImageGray = cvCreateImage(cvSize(mS_image_size.width, mS_image_size.height), 8,1);
    cvCvtColor(rightImage, rightImageGray, CV_BGR2GRAY);

    cvRemap(leftImageGray, leftImageRectified, mx1, my1);
    cvRemap(rightImageGray, rightImageRectified, mx2, my2);
