...
public:
    ...
    int rectifyImages(IplImage* leftImage, IplImage* rightImage, int rectify_mode = 1);

    int rectifyImages(IplImage* leftImage, IplImage* rightImage, CvStereoBMState* BMState);
